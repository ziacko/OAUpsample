...
namespace TinyShaders
{
	...
	namespace
	{
		...
		using shaderErrorEvent_t  = std::function<void(const shader_t* shader, std::string& entry)>;
		using shaderProgramErrorEvent_t  = std::function<void(const ShaderProgram_t* shaderProgram, std::string& entry)>;
